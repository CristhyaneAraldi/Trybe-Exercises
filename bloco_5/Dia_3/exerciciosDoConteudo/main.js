...
firstDiv.addEventListener('click', changeTech);
secondDiv.addEventListener('click', changeTech);
thirdDiv.addEventListener('click', changeTech);
...
myWebpage.addEventListener('dblclick', function() {
  window.location.replace('https://cristhyanearaldi.github.io/');
});
